...
This documentation provides instructions for using the `config-customer-app` script to build customized Dokan cloud customer mobile applications.
...
Test your installation by running any of the `config-customer-app` commands.
